...
public class MetamodelPackageImpl extends EPackageImpl implements MetamodelPackage {
	 ...
	 * @generated
	 */
	public EReference getErnaehrungsplan_Zutaten() {
		return (EReference)ernaehrungsplanEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEReference(ernaehrungsplanEClass, ERNAEHRUNGSPLAN__ZUTATEN);
	...
	public void initializePackageContents() {
		...
		initEReference(getErnaehrungsplan_Zutaten(), this.getZutat(), null, "zutaten", null, 1, -1, Ernaehrungsplan.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
